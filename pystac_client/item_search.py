...
class ItemSearch:
    ...
    Args:
        ...
        datetime: Either a single datetime or datetime range used to filter results.
            ...
            a UTC timestamp before being passed to the endpoint. Timezone unaware
            instances are assumed to represent UTC timestamps. You may represent a
            ...
            ``YYYY-mm-dd`` format, optionally truncating to ``YYYY-mm`` or just
            ``YYYY``. Simple date strings will be expanded to include the entire time
            period, for example:
